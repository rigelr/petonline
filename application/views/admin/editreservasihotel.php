<?php
$hotel=$this->db->query("SELECT*FROM reservasi_hotel WHERE id_reservasi_hotel ='".$this->uri->segment(3)."'")->row();
            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">Edit Reservasi Hotel</h4>
                    </div>
              ...
              <div class="card-body">
             <form action="<?=base_url()?>admin/proseseditreservasihotel" method="post">
                <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label">Nama</label>
                  <div class="col-sm-9">
                    <input type="hidden" class="form-control" name="id_reservasi_hotel" required value="<?=$hotel->id_reservasi_hotel?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="tanggal_stay" class="form-control"   readonly id="tgl2" autocomplete="off" value="<?=$hotel->tanggal_stay?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="jumlah_hari" class="form-control"  readonly value="<?=$hotel->jumlah_hari?> Hari">
                  </div>
                </div>
