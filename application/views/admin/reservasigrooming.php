            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-5 col-5">
                        <h4 class="page-title">Reservasi Grooming</h4>
                    </div>
                     ...
                     echo '<p class="alert alert-danger text-center">'.$this->session->flashdata('error').'</p>';
                        ...
                        <div class="table-responsive">
                             <table class="table table-striped">
                                ...
                                <?php
                                  $no=1;
                                  $hotel=$this->db->query("SELECT*FROM reservasi_grooming")->result();
                                  foreach ($hotel as $v) {
                                    ...
                                    if ($v->total_harga == 0) {
                                        $total="<a href ='".base_url()."admin/editreservasigrooming/$v->id_reservasi_grooming'class='btn btn-info'><i class='fa fa-pencil'></i></a>";
                                      ...
                                      echo "
                                        ...
                                        <td>".$no++."</td>
                                        <td>$hewan->nama</td>
                                        <td>$v->jenis_treatment</td>
                                        <td>$v->tanggal_grooming</td>
                                        <td>$total</td>
