          ...
          <div class="col-lg">
            ...
            <div class="card">
              <div class="card-header bg-secondary">
                <h2>Reservasi Grooming</h2>
              </div>
              <div class="card-body">
             <form action="<?=base_url()?>customer/prosesreservasigrooming" method="post">
                <div class="row">
              ...
              <!--  -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="tanggal_grooming" class="form-control" placeholder="Tanggal grooming" required id="tgl2" autocomplete="off">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="jenis_treatment" class="form-control" placeholder="Jenis treatment" required>
                  </div>
                </div>
